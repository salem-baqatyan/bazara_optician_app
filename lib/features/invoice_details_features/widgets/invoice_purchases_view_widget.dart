...
import 'package:optician_app/features/invoice_details_features/widgets/info_disable_field_widget.dart';
      ...
      children: [
        ...
        Table(
          ...
          children: [
            TableRow(
              children: [
                CellTableWidget(text: "ADD", bottom: false),
            ...
            TableRow(
              children: [
                CellTableWidget(text: R_ADD.text, bottom: false),
